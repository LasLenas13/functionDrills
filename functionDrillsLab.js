...
function compareNums(twoNums) {
  return (twoNums ? '$2.00' : '$10.00');
}
...
const aexclaimThree = str => str.toUpperCase() + '!!!'
...
function favaColorFinder(color){
  if(color === "red"){
...
let colorRating = favaColorFinder("pink");
...
function emailCheck(email) {
  const cutEmail = email.toString().trim();
...
console.log(emailCheck("  adfs@yahoo.com  "));
console.log(emailCheck("kjlj.gmail.com"));
...
function cocoFrogs (gold){
  return (gold/3)
}

let totalFrogs = cocoFrogs(8)
